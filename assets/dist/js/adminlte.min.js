  ...
  function b(b) {
    return this.each(function () {
      let e = a(this),
        g = e.data(c);
      if (!g) {
        let h = a.extend({}, d, e.data(), 'object' == typeof b && b);
    ...
    function b(b) {
      return this.each(function () {
        let e = a(this),
          f = e.data(c);
        if (!f) {
          let g = a.extend({}, d, e.data(), 'object' == typeof b && b);
  ...
  (function (a) {
    ...
    (g.prototype.activate = function () {
      ...
      (g.prototype.fix = function () {
        ...
        let b = a(e.mainFooter).outerHeight() || 0,
  ...
  (function (a) {
    ...
    function b(b) {
      return this.each(function () {
        let e = a(this);
        if (!e.data(c)) {
          let f = a.extend({}, d, e.data(), 'object' == typeof b && b);
          e.data(c, new h(e, f));
        }
      });
    }
