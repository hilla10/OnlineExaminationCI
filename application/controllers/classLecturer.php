...
class ClassLecturer extends CI_Controller {
    ...
    public function index()
	{
		$data = [
			...
			'subtitle'=> 'Data Lecturer Class'
		];
		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('relation/classLecturer/data');
		$this->load->view('_templates/dashboard/_footer.php');
    }

    public function data()
    {
        $this->output_json($this->master->getClassLecturer(), false);
	}
	...
	public function add()
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'title'		=> 'Add Lecturer Class',
			'subtitle'	=> 'Add Lecturer Class Data',
			'lecturer'		=> $this->master->getAllLecturer(),
			'class'	    => $this->master->getAllClass()
		];
		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('relation/classLecturer/add');
		$this->load->view('_templates/dashboard/_footer.php');
	}
	...
	public function edit($id)
	{
		$data = [
			'user' 			=> $this->ion_auth->user()->row(),
			'title'			=> 'Edit Class Lecturer',
			'subtitle'		=> 'Edit Lecturer Class Data',
		...
		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('relation/classLecturer/edit');
		$this->load->view('_templates/dashboard/_footer.php');
	}
