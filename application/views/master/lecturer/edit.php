        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                <div class="form-group">
                    ...
                    <input value="<?=$data->teacher_id?>" autofocus="autofocus" onfocus="this.select()" type="number" id="teacher_id" class="form-control" name="teacher_id" placeholder="Teacher ID">
